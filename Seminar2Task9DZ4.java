...
public class Seminar2Task9DZ4 {
    private static Logger logger = Logger.getLogger(Seminar2Task9DZ4.class.getName());

    public static void main(String[] args) throws IOException {
        FileHandler fh = new FileHandler("Seminar2Task9DZ4.txt");
